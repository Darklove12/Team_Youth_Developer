        ...
        <div className='container'>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="</a>https://images.unsplash.com/photo-1621665422246-fde75fb7e7f5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8N3xnOXpqODVsRExIRXx8ZW58MHx8fHx8&auto=format&fit=crop&w=500&q=60" />2 ladies Shoes Fashions for R1 800</li>
